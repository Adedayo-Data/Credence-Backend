...
jest.mock('redis', () => ({
  createClient: jest.fn(() => ({
    isOpen: false,
    connect: jest.fn<any>().mockResolvedValue(undefined as any),
    ping: jest.fn<any>().mockResolvedValue('PONG' as any),
    get: jest.fn<any>().mockResolvedValue(null as any),
    set: jest.fn<any>().mockResolvedValue('OK' as any),
    setEx: jest.fn<any>().mockResolvedValue('OK' as any),
    del: jest.fn<any>().mockResolvedValue(0 as any),
    keys: jest.fn<any>().mockResolvedValue([] as any),
    exists: jest.fn<any>().mockResolvedValue(0 as any),
    expire: jest.fn<any>().mockResolvedValue(0 as any),
    ttl: jest.fn<any>().mockResolvedValue(-2 as any),
    quit: jest.fn<any>().mockResolvedValue('OK' as any),
    disconnect: jest.fn<any>().mockResolvedValue(undefined as any),
    on: jest.fn(),
  }) as any),
}))
...
describe('CacheService', () => {
  ...
  beforeEach(() => {
    ...
    mockRedisConnection = {
      ...
      isHealthy: jest.fn<any>().mockResolvedValue(true as any),
    }
